...
#ifndef OPENDDS_DCPS_DISCOVERYI_H
#define OPENDDS_DCPS_DISCOVERYI_H
...
class DiscoveryI {
 public:
  ...
  // Participant
  virtual DDS::ReturnCode_t add_domain_participant(const DDS::DomainId_t domain_id,
  ...
  virtual RepoId bit_key_to_repo_id(const DomainParticipantImpl* dp,
...
public:
  ...
  // Participant
  DDS::ReturnCode_t add_domain_participant(const DDS::DomainId_t domain_id,
                                           DomainParticipantImpl* dp) override;
  ...
  RepoId bit_key_to_repo_id(const DomainParticipantImpl* participant,
			    const char* bit_topic_name,
...
#endif /* OPENDDS_DCPS_DISCOVERYI_H  */
