...
public:
  ...
  void add_publication(const GUID_t& topicId,
  ...
  void add_subscription(const GUID_t& topicId,
...
public:
  ...
  void add_publication(DDS::DomainId_t domainId,
                       const GUID_t& participantId,
                       const GUID_t& topicId,
  ...
  void add_subscription(DDS::DomainId_t domainId,
                        const GUID_t& participantId,
                        const GUID_t& topicId,
  ...
  void add_publication(
    ...
    const XTypes::TypeInformation& type_info)
  {
    endpoint_manager().add_publication(topicId, publication, qos, transInfo, publisherQos, type_info);
  }
  ...
  void add_subscription(const GUID_t& topicId,
                        ...
                        const XTypes::TypeInformation& type_info)
  {
    endpoint_manager().add_subscription(topicId, subscription, qos, transInfo,
